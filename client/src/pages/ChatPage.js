...
import {
     FaEllipsisV, FaPaperclip, FaMicrophone, FaSmile,
    FaSignOutAlt,   FaTimes,
    FaBan,  FaUserPlus, FaBell,  FaUser, FaCog,
...
const ChatPage = ({ user: propUser, token, onLogout }) => {
    ...
    // const [setIsMobilePanelOpen] = useState(false);
    ...
    const [setAppLockValue] = useState(() => localStorage.getItem('appLockValue') || '');
    ...
    const [appTheme] = useState(() => localStorage.getItem('appTheme') || 'system');
